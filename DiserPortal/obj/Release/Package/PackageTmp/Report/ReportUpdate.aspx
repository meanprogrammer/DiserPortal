        ...
        <tr>
            <td>
                <asp:GridView ID="grdSales" runat="server" AutoGenerateColumns="False" 
                    ...
                    <EmptyDataRowStyle CssClass="EmptyDataRowStyle" />
                    <Columns>
                        <asp:CommandField ButtonType="Image" SelectImageUrl="~/images/icons/modify.gif" 
                        ...
                        <asp:BoundField DataField="parentBP" HeaderText="Parent BP" 
                            SortExpression="parentBP"></asp:BoundField>
                        <asp:BoundField DataField="childBP1" HeaderText="Child BP1" 
                            SortExpression="childBP1"></asp:BoundField>
                        <asp:BoundField DataField="childBP2" HeaderText="Child BP2" 
                            SortExpression="childBP2"></asp:BoundField>
                        <asp:BoundField DataField="childBP3" HeaderText="Child BP3" 
                            SortExpression="childBP3"></asp:BoundField>
                        ...
                        <asp:BoundField DataField="dPurchased" HeaderText="Purchased Date" 
                            SortExpression="dPurchased"></asp:BoundField>
                                ...
                                <tr valign="middle">
                                    ...
                                    <td>
                                        ...
                                        <asp:DropDownList ID="ddlPageNo" runat="server" AutoPostBack="true" 
                                            Width="50px" onselectedindexchanged="ddlPageNo_SelectedIndexChanged">
                                        </asp:DropDownList>
                                        &nbsp;of&nbsp;
...
<td align="left">
    <asp:TextBox ID="txtAdd" runat="server" ReadOnly="True" 
...
<td align="left">
    <asp:TextBox ID="txtContact" runat="server" ReadOnly="True" Rows="10" 
...
<td align="left">
    <asp:DropDownList ID="ddlDBrand" runat="server" Width="450px" Enabled="False" 
        AutoPostBack="True">
    </asp:DropDownList>
</td>
</tr>
    ...
    <tr>
        <td align="left" valign="top">
            Short Code:
            <asp:ImageButton ID="imbShow" runat="server" AlternateText="Save" 
                ImageUrl="~/images/icons/search.gif" style="width: 16px" 
                ToolTip="Search Short Code" />
        </td>
        <td align="left">
            <asp:DropDownList ID="ddlSCode" runat="server" Width="450px" Enabled="False">
            </asp:DropDownList>
        </td>
    </tr>
    ...
    <tr>
        <td align="left" valign="top">
            Quantity:</td>
        <td align="left">
            <asp:TextBox ID="txtQty" runat="server" ReadOnly="True" Rows="10" 
    ...
    <tr>
        <td align="left" valign="top" width="150px">
            Date Purchased:</td>
        <td align="left" style="font-size: 9px;">
            <asp:DropDownList ID="ddlWeek" runat="server" Enabled="False" Width="225px" 
                AutoPostBack="True">
            </asp:DropDownList>
            <asp:DropDownList ID="ddlDP" runat="server" Enabled="False" Width="220px" 
                AutoPostBack="True">
            </asp:DropDownList>
            <br />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Week 
    ...
    <tr>
        <td align="left" valign="top">
            Serial Number:</td>
        <td align="left">
            <asp:TextBox ID="txtSerial" runat="server" ReadOnly="True" Rows="10" 
                Width="445px"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td align="left" valign="top">
            Invoice Number:</td>
        <td align="left">
            <asp:TextBox ID="txtInvoice" runat="server" ReadOnly="True" Rows="10" 
                Width="445px"></asp:TextBox>
        </td>
    </tr>
    <tr>
