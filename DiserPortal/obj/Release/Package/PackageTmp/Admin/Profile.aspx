...
<TR><TD align="left">&nbsp;</TD><TD align="left" height="30px">
    &nbsp;</TD></TR>
    <tr>
    ...
    <TD align="left">Password: 
        <asp:ImageButton id="imbMPwd" onclick="imbMPwd_Click" runat="server" 
            ImageUrl="~/images/icons/modify.gif" AlternateText="Modify" __designer:wfdid="w7"></asp:ImageButton> 
        <asp:ImageButton id="imbCPwd" onclick="imbCPwd_Click" runat="server" Visible="False" 
            ImageUrl="~/images/icons/cancel.gif" AlternateText="Cancel" __designer:wfdid="w9"></asp:ImageButton>
    </TD><TD align="left">
    ...
    <TD align="left">Security Answer: 
        <asp:ImageButton id="imbMAns" onclick="imbMAns_Click" runat="server" 
            ...
            __designer:wfdid="w8" style="height: 16px"></asp:ImageButton> 
        <asp:ImageButton id="imbCAns" onclick="imbCAns_Click" runat="server" Visible="False" 
            ImageUrl="~/images/icons/cancel.gif" AlternateText="Cancel" __designer:wfdid="w10"></asp:ImageButton> 
    </TD><TD align="left">
