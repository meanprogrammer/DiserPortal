...
<div style="text-align:left; padding-left:25px; vertical-align: top;">
    ...
    <td style="height:90px;" colspan="8">
        <p>CREATE - To create a new User Account Type please click on the ‘Create’ button.<br />
           EDIT - To edit an existing User Account Type please select the desired account type to edit its permissions.</p>
    </td>
...
<TD align="left">
    ...
    <asp:ImageButton id="imbAProd"  runat="server" 
        ImageUrl="~/images/icons/save.gif" AlternateText="Save" 
        style="width: 16px"></asp:ImageButton> 
    &nbsp;<asp:ImageButton id="imbMProd"  runat="server" 
        ImageUrl="~/images/icons/modify.gif" AlternateText="Modify"></asp:ImageButton>
</td>
</TR>
<tr>
<td></td>
...
<td align="left">
    ...
    <asp:ImageButton ID="imbABrand" runat="server" AlternateText="Save" 
        ImageUrl="~/images/icons/save.gif" style="width: 16px" />
    &nbsp;<asp:ImageButton ID="imbMBrand" runat="server" AlternateText="Modify" 
    ...
    <tr>
        <td colspan="3">
            <asp:GridView ID="grdItem" runat="server" AutoGenerateColumns="False" 
                ...
                ShowFooter="True" AllowPaging="True" Width="95%">
                <PagerSettings Mode="NextPreviousFirstLast" Position="TopAndBottom" />
                <RowStyle CssClass="RowStyle" />
                <EmptyDataRowStyle CssClass="EmptyDataRowStyle" />
                <Columns>
                    <asp:CommandField ButtonType="Image" 
                        SelectImageUrl="~/images/icons/modify.gif" SelectText="Modify" ShowSelectButton="True">
                    </asp:CommandField>
    ...
    <tr>
        ...
        <td align="left">
            <asp:GridView ID="grdCap" runat="server" AutoGenerateColumns="False" 
                ...
                ShowFooter="True" Width="95%" AllowPaging="True">
                <PagerSettings Mode="NextPreviousFirstLast" Position="TopAndBottom" />
                <RowStyle CssClass="RowStyle" />
                <EmptyDataRowStyle CssClass="EmptyDataRowStyle" />
                <Columns>
...
<td align="left">
    ...
    <asp:ImageButton ID="imbAVariant" runat="server" AlternateText="Save" 
        ImageUrl="~/images/icons/save.gif" style="width: 16px" />
    &nbsp;<asp:ImageButton ID="imbMVariant" runat="server" AlternateText="Modify" 
        ImageUrl="~/images/icons/modify.gif" />
</td>
</tr>
    <tr>
...
<TD align="left">
    ...
    <asp:ImageButton id="imbADealer"  runat="server" 
        ImageUrl="~/images/icons/save.gif" AlternateText="Save" 
        style="width: 16px"></asp:ImageButton> 
    &nbsp;<asp:ImageButton id="imbMDealer"  runat="server" 
        ImageUrl="~/images/icons/modify.gif" AlternateText="Modify"></asp:ImageButton>
</td>
</TR>
<tr>
...
<TD align="left">
    ...
    <asp:ImageButton id="imbALoc"  runat="server" 
        ImageUrl="~/images/icons/save.gif" AlternateText="Save" 
        style="width: 16px"></asp:ImageButton> 
    &nbsp;<asp:ImageButton id="imbMLoc"  runat="server" 
        ImageUrl="~/images/icons/modify.gif" AlternateText="Modify"></asp:ImageButton>
</td>
</TR>
<tr>
...
<td>
    <asp:GridView ID="grdStore" runat="server" AllowPaging="True" 
        ...
        DataSourceID="sqlDS_Store" ShowFooter="True" Width="95%">
        <PagerSettings Mode="NextPreviousFirstLast" Position="TopAndBottom" />
        <RowStyle CssClass="RowStyle" />
        <EmptyDataRowStyle CssClass="EmptyDataRowStyle" />
        <Columns>
            <asp:CommandField ButtonType="Image" SelectImageUrl="~/images/icons/modify.gif" SelectText="Modify"
...
<td align="left">
    <asp:GridView ID="grdCity" runat="server" AutoGenerateColumns="False" 
        CssClass="gridRow" DataSourceID="sqlDS_City" 
...
<td align="left">
    <asp:GridView ID="grdProv" runat="server" AutoGenerateColumns="False" 
        CssClass="gridRow" DataSourceID="sqlDS_Prov" 
                    ...
                    <tr valign="middle" align="center">
                        <td>
                            ...
                            <asp:ImageButton ID="imbPPrev" runat="server" AlternateText="Previous Page" 
                                ...
                                ImageUrl="~/images/icons/prev.gif" />
                        </td>
                        <td>
                            Page&nbsp;
...
<TD align="left">
    ...
    <asp:ImageButton id="imbARegion"  runat="server" 
        ImageUrl="~/images/icons/save.gif" AlternateText="Save" 
        style="width: 16px" ToolTip="Save"></asp:ImageButton> 
    &nbsp;<asp:ImageButton id="imbMRegion"  runat="server" 
        ImageUrl="~/images/icons/modify.gif" AlternateText="Modify" 
        ToolTip="Modify"></asp:ImageButton>
</td>
</TR>
<tr>
<td></td>
...
<TD align="left">
    ...
    <asp:ImageButton id="imbAAction"  runat="server" 
        ImageUrl="~/images/icons/save.gif" AlternateText="Save" 
        style="width: 16px"></asp:ImageButton> 
    &nbsp;<asp:ImageButton id="imbMAction"  runat="server" 
        ImageUrl="~/images/icons/modify.gif" AlternateText="Modify"></asp:ImageButton>
</td>
</TR>
<tr>
...
<TD align="left">
    ...
    <asp:ImageButton id="imbAQuestion"  runat="server" 
        ImageUrl="~/images/icons/save.gif" AlternateText="Save" 
        style="width: 16px"></asp:ImageButton> 
    &nbsp;<asp:ImageButton id="imbMQuestion"  runat="server" 
        ImageUrl="~/images/icons/modify.gif" AlternateText="Modify"></asp:ImageButton>
</td>
</TR>
<tr>
...
<TD align="left">
    ...
    <asp:ImageButton id="imbACBrand"  runat="server" 
        ImageUrl="~/images/icons/save.gif" AlternateText="Save"></asp:ImageButton> 
    &nbsp;<asp:ImageButton id="imbMCBrand"  runat="server" 
        ImageUrl="~/images/icons/modify.gif" AlternateText="Modify"></asp:ImageButton>
</td>
</TR>
<tr>
...
<TD align="left">
    ...
    <asp:ImageButton id="imbACCap"  runat="server" 
        ImageUrl="~/images/icons/save.gif" AlternateText="Save" 
        style="width: 16px"></asp:ImageButton> 
    &nbsp;<asp:ImageButton id="imbMCCap"  runat="server" 
        ImageUrl="~/images/icons/modify.gif" AlternateText="Modify"></asp:ImageButton>
</td>
</TR>
<tr>
...
<TD align="left">
    ...
    <asp:ImageButton id="imbASubject"  runat="server" 
        ImageUrl="~/images/icons/save.gif" AlternateText="Save" 
        style="width: 16px"></asp:ImageButton> 
    &nbsp;<asp:ImageButton id="imbMSubject"  runat="server" 
        ImageUrl="~/images/icons/modify.gif" AlternateText="Modify" 
        style="width: 16px"></asp:ImageButton>
</td>
</TR>
...
<div>
<p><asp:Button runat="server" Text="Add User" ID="btnAEmp"></asp:Button>
...
<asp:Panel ID="panUsers" runat="server">
    ...
    <div style="float:left;padding:10px 0 10px 20px;text-align:left;">
    ...
    <div style="float:right; padding:10px 20px 10px 0;">
        <strong>Filter By:</strong> &nbsp;Account Type&nbsp;&nbsp;<asp:DropDownList ID="ddlFType" 
            runat="server" AutoPostBack="True"></asp:DropDownList>
        &nbsp;&nbsp;&nbsp;&nbsp; Account Status:&nbsp;&nbsp;
        <asp:DropDownList ID="ddlFStatus" runat="server" AutoPostBack="True">
        </asp:DropDownList>
    </div><br />
    </asp:Panel>
