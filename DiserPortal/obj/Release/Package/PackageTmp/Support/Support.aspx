...
<DIV id="tab_wrap">
    <UL class="tabprop">
        <LI><br />
            <asp:LinkButton id="lnkSubmit" runat="server" CssClass="tabprop-Selected" Text="Submit a Support Ticket"></asp:LinkButton> </LI>
        <LI><br /><asp:LinkButton id="lnkMyTicket" runat="server" CssClass="tabprop" 
                Text="My Support Tickets"></asp:LinkButton></LI>
        <UL>
</DIV>
</DIV>
<!-- end tab wrap -->
